...
{
    public class SWConfigLoader : ConfigLoader<SWConfigLoader>
    {
        public const string items = "SS2.Items";
        public const string equips = "SS2.Equips";

        public override BaseUnityPlugin MainClass => SWMain.Instance;
        ...
        {
            UnlockAll =
                SWMain.Instance.Config.Bind("Starstorm 2 :: Unlock All",
                            "false",
                            false,
                            "Setting this to true unlocks all the content in Starstorm 2, excluding skin unlocks.");
            EnableFunnyCanister =
                SWMain.Instance.Config.Bind("Starstorm 2 :: Equipment",
